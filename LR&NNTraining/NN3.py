...
class NeuralNet:
    ...
    def fit(self,X,y):
        ...
        for i in range(5000):
            ...
            self.theta2 = self.theta2 - (gradient_theta2/n)*0.0001
            self.bias2 = self.bias2 - (gradient_bias2/n)*0.0001
            self.theta1 = self.theta1 - (gradient_theta1/n)*0.0001
            self.bias1 = self.bias1 - (gradient_bias1/n)*0.0001
...
hidden = 5
g = NeuralNet(2,hidden,2)
g.fit(X,y)
plot_decision_boundary(g,X,y)
